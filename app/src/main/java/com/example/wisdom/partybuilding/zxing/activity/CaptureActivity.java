package com.example.wisdom.partybuilding.zxing.activity;
...
import com.example.wisdom.partybuilding.zxing.view.ViewfinderView;
...
//                                handler.sendMessage(m);
    ...
    public Result scanningImage(String path) {
        ...
        scanBitmap = BitmapFactory.decodeFile(path, options);
        com.example.wisdom.partybuilding.zxing.decoding.RGBLuminanceSource source = new com.example.wisdom.partybuilding.zxing.decoding.RGBLuminanceSource(scanBitmap);
